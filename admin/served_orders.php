			...
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Served Orders
						...
						<a href="confirmed_orders.php" class="btn btn-secondary btn-sm"> confirmed orders</a>
					</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">served orders</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
				...
				<div class="col-md-4">
					...
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Served Orders List</h3>
						</div>
						...
						<div class="card-body">
							<table id="example4" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
									$query = "SELECT * FROM basket where status='served'";
					...
					<div class="col-md-8">
						<div class="card card-success">
							...
							if (isset($_GET['orderID'])) {
								...
								$sql = "SELECT * FROM basket where id='$ordId' AND status='served'";
										...
										<form method="POST" enctype="multipart/form-data">
											...
											{  
												...
												if (isset($_GET['orderID'])) {
													...
													<tr>
														<th>Order Status</th>
														<td> <a href="#" style="color: white;background: green;padding: 8px;" onclick='return confirm("This order is already served")'><?php echo $status; ?></a></td>

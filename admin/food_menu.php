				...
				<div class="col-md-12 col-lg-12">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Table with Saved food menu <a href="?breakfast=break" class="btn btn-default btn-xs text-info" style="margin-left: 50px;">  Break fast</a><a href="?lunch=lunch" class="btn btn-default btn-xs text-info" style="margin-left: 12px;">Lunch</a><a href="?dinner=dinner" class="btn btn-default btn-xs text-info" style="margin-left: 12px;">  Dinner</a><a href="?special=special" class="btn btn-default btn-xs text-info" style="margin-left: 12px;">  Special</a></h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							<table id="example3" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
									if (isset($_GET['breakfast'])=='break') {
										$sql = "SELECT * FROM food where food_category='breakfast'";
									}
									else if (isset($_GET['lunch'])=='lunch') {
										$sql = "SELECT * FROM food where food_category='lunch'";
									}
									else if (isset($_GET['dinner'])=='dinner') {
										$sql = "SELECT * FROM food where food_category='dinner'";
									}
									else if (isset($_GET['special'])=='special') {
										$sql = "SELECT * FROM food where food_category='special'";
									}
									else{

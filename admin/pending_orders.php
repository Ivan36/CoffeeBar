					...
					<div class="card card-primary">
						...
						<div class="card-body">
							<table id="example4" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
									$query = "SELECT * FROM basket where status='pending'";
					...
					<div class="col-md-8">
						<div class="card card-success">
							...
							<?php if (isset($_GET['orderID'])) {
								...
								$sql = "SELECT * FROM basket where id='$ordId' AND status='pending'";
											...
											// $result = mysqli_query($connect, $sql); 
												...
												<tr>
													...
													<td style="padding-top: 15px;">
														<a href="" style="color: white;background: red;padding: 8px;" onclick='return confirm("This order is still pending select an option for this order and submit")'><?php echo $status; ?>

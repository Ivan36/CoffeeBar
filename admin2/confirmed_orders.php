...
$count = $db->query("SELECT * FROM basket where status='confirmed'");
...
$orders = $db->query("SELECT * FROM basket where status='confirmed' LIMIT $start, $per_page");
				...
				<div class="card">
					...
					<div class="content table-responsive table-full-width">
						...
						<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
							for($i = 1; $i <= $pages; $i++) {
								echo ($i == $page) ? "<a href='confirmed_orders.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #FF5722;' >$i</a>  "  : " <a href='confirmed_orders.php?page=".$i."' class='btn'>$i</a> ";
							}
						} ?></p>

				...
				if(count($table_array) < $table_count) {
					...
					if($check->num_rows) {
						...
						if($insert) {
							...
							$msg = "<p style='padding: 15px; color: green; background: #eeffee; font-weight: bold; font-size: 13px; border-radius: 4px; text-align: center;'>Reservation placed successfully. Your reservation code is $reserve_code. Please Note that your reservation expires after One hour</p>";

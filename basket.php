		...
		<body>
			...
			<div class="info_holder">
				...
				<?php if (isset($_SESSION['ID'])) {
					$query = $db->query("SELECT * from tblcustomers where ID='$userid'");
					$row = $query->fetch_assoc();
					?>

				<h2><span class="tag">Confirm Your personal info and place your Order</span></h2>
					...
					<form method="post" action="" onSubmit="validate_input(); return false">
						...
						<div class="form_group">
							...
							<div class="form_group">
								...
								<label>Name</label>
								<input type="text" id="name" name="name" value="<?php echo $row['Name'] ?>" required readonly>
							...
							<div class="form_group">
								...
								<label>Address</label>
								<input type="text" id="addr"  name="addr" value="<?php echo $row['Details'] ?>" required readonly>
							...
							<div class="form_group">
								...
								<input type="text" id="phone" name="phone" value="<?php echo $row['MobileNumber'] ?>"  required readonly>
				...
				<h2><span class="tag">Complete the form and place your Order</span></h2>
					<form method="post" action="" onSubmit="validate_input(); return false">

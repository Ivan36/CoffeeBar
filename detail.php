			...
			<div class="detail_holder">
				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<p><span class="bold_desc price">Price:</span> Ugx <span id="price"><?php echo $price; ?></span></p>
						<div class="form_group">
							...
							<p><span class="bold_desc">Total Price:</span> Ugx <span id="total_price"><?php echo $price; ?></span></p>
